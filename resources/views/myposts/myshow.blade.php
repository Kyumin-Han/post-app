...
<html lang="en">
    ...
    <body>
        <div class="container">
            <div class="mt-5">
                <a href="{{ route('posts.mypost',['page'=>$page]) }}">목록보기</a>
            </div>
            <div class="mt-5">
                <div class="mb-3">
                ...
                <div class="flex">
                        ...
                        onclick="location.href='{{ route('posts.myedit', ['post'=>$post->id, 'page'=>$page]) }}'">수정</button>
                    

                    <form class="deletebtn"
                        action="{{ route('posts.mydelete', ['id'=>$post->id, 'page'=>$page]) }}"
                        method="post">
                        @csrf @method("delete")
